...
std::vector<ConfigItem<int>> CFG::getIntItems()
{
    return {
        ...
        {"stream0.osd.start_delay", stream0.osd.start_delay, 0, [](const int &v) { return v >= 1 && v <= 5000; }},
        ...
        {"stream1.osd.start_delay", stream1.osd.start_delay, 0, [](const int &v) { return v >= 1 && v <= 5000; }},
